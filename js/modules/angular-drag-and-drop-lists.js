...
angular.module('dndLists', [])
   ...
   */
  .directive('dndList', ['$parse', '$timeout', 'dndDropEffectWorkaround', 'dndDragTypeWorkaround','TaskService',
                 function($parse,   $timeout,   dndDropEffectWorkaround,   dndDragTypeWorkaround,   TaskService) {
    return function(scope, element, attr) {
